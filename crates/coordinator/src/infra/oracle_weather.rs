...
//!   high and wind as maxima, the low as a minimum), as of the latest report, with the times of
//!   the first and latest reports.
...
//! wait on the oracle; see `domain::leaderboard`.
...
pub struct StationObservations {
    ...
    /// The first and latest reports inside the window.
    pub first_report: Option<OffsetDateTime>,
    ...
    pub async fn observations(
        ...
        Ok(rows
            ...
            .map(|row| StationObservations {
                ...
                first_report: parse(row.start_time),
