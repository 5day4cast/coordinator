...
export const taprootwallet_getCurrentOutcome: (a: number, b: number, c: number, d: any) => [number, number, number, number];
...
export const closure676_externref_shim: (a: number, b: number, c: any) => void;
export const closure777_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h69ac59dfcd2e25fb: (a: number, b: number) => void;
export const closure1112_externref_shim: (a: number, b: number, c: any) => void;
export const closure1124_externref_shim: (a: number, b: number, c: any, d: any) => void;
