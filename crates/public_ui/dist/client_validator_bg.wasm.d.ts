...
export const taprootwallet_signFundingPsbt: (a: number, b: any, c: number) => [number, number, number];
...
export const closure1488_externref_shim: (a: number, b: number, c: any) => void;
export const closure1500_externref_shim: (a: number, b: number, c: any, d: any) => void;
