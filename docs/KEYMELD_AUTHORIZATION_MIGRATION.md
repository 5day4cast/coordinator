...
The workspace pins one Keymeld revision in [Cargo.toml](../Cargo.toml) and in the flake's keymeld input (currently the payout-escrow head of tee8z/keymeld#56, on top of `v0.4.1`).
